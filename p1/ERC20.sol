...
contract MyToken is ERC20Interface {
     ...
     */
    string public constant name = "sf647"; // TODO CHANGE THIS!

    /**
     * @dev Returns the symbol of the token, usually a shorter version of the
     * name.
     */
    string public constant symbol = "MYT"; // TODO: You can change this, too
    ...
    function withdraw(uint256 numTokens) public virtual override returns (bool success) {
        ...
        require(address(this).balance >= numTokens * 1000, "Insufficient contract balance");
        _accountBalances[msg.sender]-=numTokens;
        _totalSupply-=numTokens;
        emit Transfer(msg.sender,address(0),numTokens);
        (bool sent, )=msg.sender.call{value:numTokens*1000}("");
